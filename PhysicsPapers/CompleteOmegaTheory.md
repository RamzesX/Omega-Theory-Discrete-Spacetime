...
(iii) the *entanglement projection* $D_{\text{ent}}$, in which entangled particles are adjacent regardless of their separation in the spacetime projection — the Einstein-Rosen-bridge interpretation (§5.4 below; direct ER=EPR theorem is open, see §9).
