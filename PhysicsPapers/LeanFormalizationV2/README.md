...
| Files | ~76 (75 under `OmegaTheory/` + `OmegaTheory.lean`) |
| Theorems + definitions | ~1400 |
| Sorry | **0** (all proofs complete, April 15 2026) |
| Axioms | **9** declared (8 physical constants + HPW) — **HPW is provably replaceable** on 3 regimes (flat, linearised, static-spherical vacuum) via `HpwEliminableRegime` typeclass |
| Build | **3424 jobs, clean** |
