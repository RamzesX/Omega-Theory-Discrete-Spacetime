...
> This document is historically preserved only. All live experimental claims and Lean-verified predictions have moved to [`Appendix-J-Experimental-Catalog-Consolidated.md`](./Appendix-J-Experimental-Catalog-Consolidated.md). Per-theorem GitHub badges are available at [`LEAN_VERIFIED_CLAIMS.md`](./LEAN_VERIFIED_CLAIMS.md). Build state at supersession: 3818 jobs GREEN, 0 sorry, 8 physical axioms.
