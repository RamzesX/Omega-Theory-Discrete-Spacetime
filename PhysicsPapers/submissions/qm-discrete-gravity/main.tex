...
\path{PhysicsPapers/LeanFormalizationV2/}. Build state (2026-04-21):
\textbf{3{,}835 jobs GREEN, 0 \code{sorry}, 8 physical axioms}; the
\code{OmegaTheoryV2} Neo4j corpus contains 8{,}996 \code{Theorem} nodes.
All 19 \code{paper\_*} wrapper theorems plus the capstone
\code{grand\_qm\_emergence} (and its Minkowski variant) are verified
against the graph (19/19 present, 2026-04-21 audit).
