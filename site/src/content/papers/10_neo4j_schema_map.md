...
<!-- orig-frontmatter: name: 10_neo4j_schema_map -->
<!-- orig-frontmatter: date: 2026-04-18 -->
<!-- orig-frontmatter: author: Izar (epsilon Bootis, Docs-Nu) -->
<!-- orig-frontmatter: status: v1 -->
<!-- orig-frontmatter: purpose: map every design decision in memos 01-09 to its Cypher realization in LeanFormalizationV2/.neo4j/*.cypher -->
