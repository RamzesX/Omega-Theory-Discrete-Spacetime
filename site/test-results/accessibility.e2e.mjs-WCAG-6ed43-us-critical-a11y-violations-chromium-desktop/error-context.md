...
- Name: accessibility.e2e.mjs >> WCAG accessibility (axe-core) >> paperQM — no serious/critical a11y violations
- Location: tests/accessibility.e2e.mjs:36:5

# Error details

```
Error: axe serious/critical violations on /papers/paper-qm-from-discrete-gravity/: scrollable-region-focusable (4)
