...
- Name: appearance.e2e.mjs >> visual regression (baseline screenshots) >> home page
- Location: tests/appearance.e2e.mjs:143:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Expected an image 1440px by 900px, received 1440px by 4026px. 1770291 pixels (ratio 0.31 of all image pixels) are different.
