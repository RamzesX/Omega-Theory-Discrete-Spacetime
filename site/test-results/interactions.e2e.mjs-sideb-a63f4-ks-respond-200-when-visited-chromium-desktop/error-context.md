...
- Name: interactions.e2e.mjs >> sidebar navigation: every link actually navigates >> all sidebar links respond 200 when visited
- Location: tests/interactions.e2e.mjs:31:3
